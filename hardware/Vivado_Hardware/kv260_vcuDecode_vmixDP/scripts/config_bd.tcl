...
proc create_root_design { parentCell } {
  ...
  # Create instance: axi_gpio_0 (4-bit output for PMOD LEDs), and set properties
  ...
  connect_bd_intf_net -intf_net axi_ic_accel_ctrl_M01_AXI [get_bd_intf_pins axi_ic_accel_ctrl/M01_AXI] [get_bd_intf_pins axi_gpio_0/S_AXI]
  ...
  connect_bd_net -net clk_wiz_0_clk_275M [get_bd_pins ${::PS_INST}/maxihpm0_fpd_aclk] [get_bd_pins axi_ic_accel_ctrl/M01_ACLK] -boundary_type upper
  connect_bd_net -net clk_wiz_0_clk_275M [get_bd_pins ${::PS_INST}/maxihpm0_fpd_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] -boundary_type upper
  ...
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins axi_ic_accel_ctrl/M00_ARESETN] [get_bd_pins axi_ic_accel_ctrl/M01_ARESETN] -boundary_type upper
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins axi_ic_accel_ctrl/M00_ARESETN] [get_bd_pins axi_gpio_0/s_axi_aresetn] -boundary_type upper
  ...
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ${::PS_INST}/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] -force
